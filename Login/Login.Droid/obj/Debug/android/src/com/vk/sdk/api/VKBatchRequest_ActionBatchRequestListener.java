...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VKontakte.API.VKBatchRequest+ActionBatchRequestListener, VKontakte.Android", VKBatchRequest_ActionBatchRequestListener.class, __md_methods);
	}


	public VKBatchRequest_ActionBatchRequestListener ()
	{
		super ();
		if (getClass () == VKBatchRequest_ActionBatchRequestListener.class)
			mono.android.TypeManager.Activate ("VKontakte.API.VKBatchRequest+ActionBatchRequestListener, VKontakte.Android", "", this, new java.lang.Object[] {  });
	}
