...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VKontakte.API.VKRequest+ActionRequestListener, VKontakte.Android", VKRequest_ActionRequestListener.class, __md_methods);
	}
	...
	public VKRequest_ActionRequestListener ()
	{
		...
		if (getClass () == VKRequest_ActionRequestListener.class)
			mono.android.TypeManager.Activate ("VKontakte.API.VKRequest+ActionRequestListener, VKontakte.Android", "", this, new java.lang.Object[] {  });
	}
